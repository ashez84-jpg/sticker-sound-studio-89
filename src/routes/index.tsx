...
const SLOTS: Record<Gender, Record<PajamaId, Slot[]>> = {
  boy: {
    stars: buildSlots({ dy: 0, cannulaY: 33.6, chestY: 51, chestW: 30, bellyY: 60, bellyW: 27 }),
    dino: buildSlots({ dy: 0, cannulaY: 31.4, chestY: 50, chestW: 31, bellyY: 59, bellyW: 29 }),
    hearts: buildSlots({ dy: 0, cannulaY: 33.4, chestY: 51, chestW: 30, bellyY: 60, bellyW: 27 }),
  },
  girl: {
    stars: buildSlots({ dy: -0.8, cannulaY: 31.5, chestY: 52.5, chestW: 32, bellyY: 62.5, bellyW: 29 }),
    dino: buildSlots({ dy: -0.8, cannulaY: 32.5, chestY: 52, chestW: 32, bellyY: 62, bellyW: 30 }),
    hearts: buildSlots({ dy: -0.8, cannulaY: 31.3, chestY: 52, chestW: 31, bellyY: 61.5, bellyW: 29 }),
  },
};
